    ...
    public CommandLineRunner seedDatabase(
        ...
        return args -> {
            if (licaoRepository.count() == 0) {
                ...
                licao1.setConteudo(
                        "Educação financeira é muito mais do que simplesmente economizar moedas. Trata-se de compreender como o dinheiro funciona no mundo: como as pessoas o ganham, o gerenciam, o investem e o doam. Ela capacita você a tomar decisões conscientes e responsáveis com seus recursos, construindo uma base sólida para a realização de sonhos e estabilidade futura.");
                licao1.setExemplo(
                        "Se você ganha R$ 2.000 por mês, mas gasta R$ 2.100 no cartão de crédito, você está acumulando dívidas. A educação financeira ensina você a planejar suas despesas para viver sempre abaixo dos seus ganhos e investir a diferença.");
                ...
                pergunta1.setOpcaoB(
                        "Compreender o fluxo do dinheiro para tomar decisões conscientes e planejar o futuro.");
                ...
                pergunta1.setExplicacao(
                        "A educação financeira visa dar clareza sobre receitas e despesas para que você tome decisões que tragam segurança, bem-estar e independência financeira.");
                ...
                licao2.setConteudo(
                        "Os juros simples são calculados apenas sobre o valor principal inicial investido ou emprestado. Já os juros compostos são calculados sobre o valor acumulado de cada período (o principal mais os juros já gerados). Este fenômeno é conhecido como 'juros sobre juros' e atua como um multiplicador exponencial de patrimônio ao longo do tempo.");
                licao2.setExemplo(
                        "Investir R$ 1.000 a uma taxa de 10% ao ano em juros simples gera R$ 100 de rendimento todo ano. Em juros compostos, no primeiro ano rende R$ 100, mas no segundo ano rende R$ 110 (10% de R$ 1.100), e assim por diante.");
                ...
                pergunta2.setOpcaoC(
                        "Os juros de cada período acumulam ao saldo principal, servindo de base para novos cálculos de juros.");
                pergunta2.setOpcaoD("Eles são idênticos aos juros simples e rendem o mesmo valor mensal.");
                pergunta2.setRespostaCorreta(3);
                pergunta2.setExplicacao(
                        "Os juros compostos geram o efeito 'bola de neve', pois os juros rendem novos juros a cada período consecutivo.");
                ...
                licao3.setExemplo(
                        "Se você recebe R$ 3.000 líquidos, você destinará R$ 1.500 para pagar suas contas de necessidades essenciais, R$ 900 para passeios e assinaturas digitais, e R$ 600 para investir em sua reserva de emergência.");
                ...
                pergunta3.setExplicacao(
                        "A regra sugere destinar a maior metade (50%) para necessidades, 30% para gastos flexíveis e divertidos, e separar 20% para o seu futuro financeiro.");
                ...
                licao4.setExemplo(
                        "Se suas contas e despesas básicas mensais somam R$ 1.500, o tamanho ideal de sua reserva de emergência fica entre R$ 4.500 (3 meses) e R$ 9.000 (6 meses).");
                ...
                pergunta4.setPergunta(
                        "Qual a principal característica que o investimento da reserva de emergência deve possuir?");
                ...
                pergunta4.setExplicacao(
                        "Uma emergência requer dinheiro na mão rapidamente. Por isso, a reserva precisa de liquidez imediata e segurança total, evitando perdas inesperadas.");
                ...
                licao5.setConteudo(
                        "Os investimentos dividem-se em duas grandes classes. A Renda Fixa funciona como um empréstimo do seu dinheiro a um banco ou ao governo em troca de juros definidos (CDB, Tesouro Selic, LCI/LCA). Possui alta previsibilidade e segurança. Na Renda Variável, você compra partes de empresas ou imóveis (Ações, FIIs). Não há garantia de rendimento e os preços oscilam diariamente na bolsa, trazendo mais risco, porém potencial de lucros bem maiores.");
                licao5.setExemplo(
                        "Investir R$ 1.000 em um CDB que rende 100% do CDI é Renda Fixa: você sabe como o saldo crescerá. Comprar R$ 1.000 em ações de uma empresa cotada em bolsa é Renda Variável: em um dia suas ações podem passar a valer R$ 1.050 e, no outro, cair para R$ 950.");
                ...
                pergunta5.setPergunta(
                        "Qual é a principal diferença entre investimentos de Renda Fixa e Renda Variável?");
                pergunta5
                        .setOpcaoA("Renda Fixa é sempre isenta de impostos, enquanto a Variável cobra taxas absurdas.");
                pergunta5.setOpcaoB(
                        "Renda Fixa oferece previsibilidade de regras e segurança, enquanto Renda Variável possui preços oscilantes sem rentabilidade garantida.");
                pergunta5.setOpcaoC(
                        "Renda Variável é recomendada para reservas de emergência e Renda Fixa para especulação financeira.");
                pergunta5.setOpcaoD("Renda Fixa nunca rende juros compostos, somente a Renda Variável.");
                pergunta5.setRespostaCorreta(2);
                pergunta5.setExplicacao(
                        "A Renda Fixa se destaca pela segurança e regras predefinidas. A Renda Variável envolve risco de mercado, com cotações que mudam com a oferta e demanda na Bolsa de Valores.");
            ...
            if (perfilRepository.count() == 0) {
                Perfil estudante1 = new Perfil(null, "Diego Pedro", "diego@edu.com", 240, 3, null, 125000.0,
                        LocalDateTime.now().minusDays(5));
                Perfil estudante2 = new Perfil(null, "Ygor Bitencourt", "ygor@edu.com", 160, 2, null, 108400.0,
                        LocalDateTime.now().minusDays(4));
                Perfil estudante3 = new Perfil(null, "Mohamad Assaf", "mohamad@edu.com", 140, 2, null, 95800.0,
                        LocalDateTime.now().minusDays(3));
                Perfil estudante4 = new Perfil(null, "Ana Silva", "ana@edu.com", 80, 1, null, 100000.0,
